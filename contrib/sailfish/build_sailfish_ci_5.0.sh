...
sb2 -t SailfishOS-${VERSION_ID}-armv7hl -m sdk-build rpmbuild --define "_topdir /home/appsupport-root/rpmbuild" --define "navit_source ${SCRIPTPATH}/../.." -bb navit-sailfish_5.0.spec
#intel devices
...
sb2 -t SailfishOS-${VERSION_ID}-aarch64 -m sdk-build rpmbuild --define "_topdir /home/appsupport-root/rpmbuild" --define "navit_source ${SCRIPTPATH}/../.." -bb navit-sailfish_5.0.spec
