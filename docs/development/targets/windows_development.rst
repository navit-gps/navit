...
First, setup compiling in linux ubuntu explained in :doc:`linux_development`
...
:doc:`wince_development` may have details that are relevant for compilation on WindowsCE / Windows Mobile.
...
Using the variant arm-mingw32ce of CeGCC 0.59.1 it was possible to build a working executable which can be debugged (see :doc:`wince_development`).
