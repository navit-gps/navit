...
static struct event_methods event_glib_methods = {
    .main_loop_run = event_glib_main_loop_run,
    .main_loop_quit = event_glib_main_loop_quit,
    .add_watch = event_glib_add_watch,
    .remove_watch = event_glib_remove_watch,
    .add_timeout = event_glib_add_timeout,
    .remove_timeout = event_glib_remove_timeout,
    .add_idle = event_glib_add_idle,
    .remove_idle = event_glib_remove_idle,
    .call_callback = event_glib_call_callback,
};
