...
struct graphics_opengl_window_system_methods {
    ...
    void (*set_callbacks)(struct graphics_opengl_window_system *, void *data, void *resize, void *button, void *motion,
                          void *keypress);
};
...
struct graphics_opengl_window_system *graphics_opengl_x11_new(void *displayname, int w, int h, int depth,
