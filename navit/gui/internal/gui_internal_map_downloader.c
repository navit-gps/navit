...
/*void gui_internal_map_downloader(struct gui_priv *this, struct widget *wm, void *data) {
    ...
    if(! this->download_cb) {
        ...
        //this->download_cb = event_add_timeout(500, 0, callback_new_1(callback_cast(gui_internal_download_update), this));
        this->download_cb = callback_new_1(callback_cast(gui_internal_download_update), this);
        //event_add_timeout(500, 0, callback_new_1(callback_cast(gui_internal_download_update), this));
