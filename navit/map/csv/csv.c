...
static struct item_methods methods_csv = {
    .item_coord_rewind = csv_coord_rewind,
    .item_coord_get = csv_coord_get,
    .item_attr_rewind = csv_attr_rewind,
    .item_attr_get = csv_attr_get,
    .item_coord_is_node = NULL,
    .item_attr_set = csv_attr_set,
    .item_coord_set = csv_coord_set,
    .item_type_set = csv_type_set,
    .item_coords_left = NULL,
};
