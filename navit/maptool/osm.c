...
struct country_table {
    ...
    struct rect r;
    int nparts;
} country_table[] = { { 4, "Afghanistan" }, { 8, "Albania" }, { 10, "Antarctica" }, { 12, "Algeria" }, { 16,
        "American Samoa" }, { 20, "Andorra" }, { 24, "Angola" }, { 28, "Antigua and Barbuda" }, { 31, "Azerbaijan" }, {
        32, "Argentina,República Argentina,AR " }, { 36, "Australia,AUS", "3s456c8" }, { 40, "Austria,Österreich,AUT",
        "3s5c78" }, { 44, "Bahamas" }, { 48, "Bahrain" }, { 50, "Bangladesh" }, { 51, "Armenia" }, { 52, "Barbados" }, {
        56, "Belgium,Belgique,Belgie,België,Belgien", "345c7M" }, { 60, "Bermuda" }, { 64, "Bhutan" }, { 68,
        "Bolivia, Plurinational State of" }, { 70, "Bosnia and Herzegovina,Bosna i Hercegovina,Босна и Херцеговина" }, {
        72, "Botswana" }, { 74, "Bouvet Island" }, { 76, "Brazil", "3s5cm8" }, { 84, "Belize" }, { 86,
        "British Indian Ocean Territory" }, { 90, "Solomon Islands" }, { 92, "Virgin Islands, British" }, { 96,
        "Brunei Darussalam" }, { 100, "Bulgaria,България", "3s5cm8" }, { 104, "Myanmar" }, { 108, "Burundi" }, { 112,
        "Belarus", "3s5c78" }, { 116, "Cambodia" }, { 120, "Cameroon" }, { 124, "Canada", "3scm78" }, { 132,
        "Cape Verde" }, { 136, "Cayman Islands" }, { 140, "Central African Republic" }, { 144, "Sri Lanka" }, { 148,
        "Chad" }, { 152, "Chile" }, { 156, "China" }, { 158, "Taiwan, Province of China" }, { 162, "Christmas Island" },
        { 166, "Cocos (Keeling) Islands" }, { 170, "Colombia" }, { 174, "Comoros" }, { 175, "Mayotte" },
        { 178, "Congo" }, { 180, "Congo, the Democratic Republic of the" }, { 184, "Cook Islands" },
        { 188, "Costa Rica" }, { 191, "Croatia,Republika Hrvatska,HR", "34scm8" }, { 192, "Cuba" }, { 196, "Cyprus",
                "345c7m" }, { 203, "Czech Republic,Česká republika,CZ", "345cm8" }, { 204, "Benin" }, { 208,
                "Denmark,Danmark,DK", "3c56m8" }, { 212, "Dominica" }, { 214, "Dominican Republic" },
        { 218, "Ecuador" }, { 222, "El Salvador" }, { 226, "Equatorial Guinea" }, { 231, "Ethiopia" },
        { 232, "Eritrea" }, { 233, "Estonia,Eesti", "345cm8" }, { 234, "Faroe Islands,Føroyar" }, { 238,
                "Falkland Islands (Malvinas)" }, { 239, "South Georgia and the South Sandwich Islands" },
        { 242, "Fiji" }, { 246, "Finland,Suomi", "3s5cm8" }, { 248, "Åland Islands" }, { 250,
                "France,République française,FR", "3s5c7M" }, { 254, "French Guiana" }, { 258, "French Polynesia" }, {
                260, "French Southern Territories" }, { 262, "Djibouti" }, { 266, "Gabon" },
        { 268, "Georgia", "3s5c78" }, { 270, "Gambia" }, { 275, "Palestinian Territory, Occupied" }, { 276,
                "Germany,Deutschland,Bundesrepublik Deutschland", "3s5c7M" }, { 288, "Ghana" }, { 292, "Gibraltar" }, {
                296, "Kiribati" }, { 300, "Greece" }, { 304, "Greenland" }, { 308, "Grenada" }, { 312, "Guadeloupe" }, {
                316, "Guam" }, { 320, "Guatemala" }, { 324, "Guinea" }, { 328, "Guyana" }, { 332, "Haiti" }, { 334,
                "Heard Island and McDonald Islands" }, { 336, "Holy See (Vatican City State)" }, { 340, "Honduras" }, {
                344, "Hong Kong" }, { 348, "Hungary,Magyarország", "345c78" }, { 352, "Iceland", "34cm78" }, { 356,
                "India", "3sc6m8" }, { 360, "Indonesia" }, { 364, "Iran, Islamic Republic of" }, { 368, "Iraq" }, { 372,
                "Ireland", "345c78" }, { 376, "Israel" }, { 380, "Italy,Italia", "3s5c78" }, { 384, "Côte d'Ivoire" }, {
                388, "Jamaica" }, { 392, "Japan", "3s5cm8" }, { 398, "Kazakhstan" }, { 400, "Jordan" },
        { 404, "Kenya" }, { 408, "Korea, Democratic People's Republic of", "3s5cm8" }, { 410, "Korea, Republic of",
                "3s5cm8" }, { 412, "Kosovo,Kosova" }, { 414, "Kuwait" }, { 417, "Kyrgyzstan" }, { 418,
                "Lao People's Democratic Republic" }, { 422, "Lebanon" }, { 426, "Lesotho" }, { 428, "Latvia,Latvija",
                "345c78" }, { 430, "Liberia" }, { 434, "Libyan Arab Jamahiriya" }, { 438, "Liechtenstein" }, { 440,
                "Lithuania,Lietuva", "3cm67T" }, { 442, "Luxembourg", "3s5c78" }, { 446, "Macao" },
        { 450, "Madagascar" }, { 454, "Malawi" }, { 458, "Malaysia" }, { 462, "Maldives" }, { 466, "Mali" }, { 470,
                "Malta" }, { 474, "Martinique" }, { 478, "Mauritania" }, { 480, "Mauritius" },
        { 484, "Mexico", "3s5m78" }, { 492, "Monaco" }, { 496, "Mongolia" }, { 498, "Moldova, Republic of" }, { 499,
                "Montenegro,Црна Гора,Crna Gora" }, { 500, "Montserrat" }, { 504, "Morocco" }, { 508, "Mozambique" }, {
                512, "Oman" }, { 516, "Namibia" }, { 520, "Nauru" }, { 524, "Nepal" }, { 528,
                "Nederland,The Netherlands,Niederlande,NL,Netherlands", "3c567M" }, { 530, "Netherlands Antilles" }, {
                531, "Curacao" }, { 533, "Aruba" }, { 534, "Sint Maarten (Dutch part)" }, { 535,
                "Bonaire, Sint Eustatius and Saba" }, { 540, "New Caledonia" }, { 548, "Vanuatu" }, { 554,
                "New Zealand", "3s5m78" }, { 558, "Nicaragua" }, { 562, "Niger" }, { 566, "Nigeria" }, { 570, "Niue" },
        { 574, "Norfolk Island" }, { 578, "Norway,Norge,Noreg,NO", "3c56m8" }, { 580, "Northern Mariana Islands" }, {
                581, "United States Minor Outlying Islands" }, { 583, "Micronesia, Federated States of" }, { 584,
                "Marshall Islands" }, { 585, "Palau" }, { 586, "Pakistan" }, { 591, "Panama" }, { 598,
                "Papua New Guinea" }, { 600, "Paraguay" }, { 604, "Peru" }, { 608, "Philippines" }, { 612, "Pitcairn" },
        { 616, "Poland,Polska,PL", "3s5cmT" }, { 620, "Portugal", "345cm8" }, { 624, "Guinea-Bissau" }, { 626,
                "Timor-Leste" }, { 630, "Puerto Rico" }, { 634, "Qatar" }, { 638, "Réunion" }, { 642,
                "România,Romania,RO", "sc5m78" }, { 643, "Россия,Российская Федерация,Russia,Russian Federation",
                "3s5c7m" }, { 646, "Rwanda" }, { 652, "Saint Barthélemy" }, { 654,
                "Saint Helena, Ascension and Tristan da Cunha" }, { 659, "Saint Kitts and Nevis" }, { 660, "Anguilla" },
        { 662, "Saint Lucia" }, { 663, "Saint Martin (French part)" }, { 666, "Saint Pierre and Miquelon" }, { 670,
                "Saint Vincent and the Grenadines" }, { 674, "San Marino" }, { 678, "Sao Tome and Principe" }, { 682,
                "Saudi Arabia" }, { 686, "Senegal" }, { 688, "Srbija,Србија,Serbia", "3scm78" }, { 690, "Seychelles" },
        { 694, "Sierra Leone" }, { 702, "Singapore" }, { 703, "Slovakia,Slovensko,SK", "3c567m" }, { 704, "Viet Nam" },
        { 705, "Slovenia,Republika Slovenija,SI", "34s6cm" }, { 706, "Somalia" }, { 710, "South Africa" }, { 716,
                "Zimbabwe" }, { 724, "Spain,Espana,España,Reino de Espana,Reino de España", "345scm" }, { 728,
                "South Sudan" }, { 732, "Western Sahara" }, { 736, "Sudan" }, { 740, "Suriname" }, { 744,
                "Svalbard and Jan Mayen" }, { 748, "Swaziland" }, { 752, "Sweden,Sverige,Konungariket Sverige,SE",
                "3c56m8" }, { 756, "Switzerland,Schweiz", "3s5c7M" }, { 760, "Syrian Arab Republic" }, { 762,
                "Tajikistan" }, { 764, "Thailand" }, { 768, "Togo" }, { 772, "Tokelau" }, { 776, "Tonga" }, { 780,
                "Trinidad and Tobago" }, { 784, "United Arab Emirates" }, { 788, "Tunisia" },
        { 792, "Turkey", "sc5m78" }, { 795, "Turkmenistan" }, { 796, "Turks and Caicos Islands" }, { 798, "Tuvalu" }, {
                800, "Uganda" }, { 804, "Ukraine", "3s5c78" }, { 807, "Macedonia,Македонија" }, { 818, "Egypt" }, { 826,
                "United Kingdom,UK", "3s5c7m" }, { 831, "Guernsey" }, { 832, "Jersey" }, { 833, "Isle of Man" }, { 834,
                "Tanzania, United Republic of" }, { 840, "USA", "3s5c7m" }, { 850, "Virgin Islands, U.S." }, { 854,
                "Burkina Faso" }, { 858, "Uruguay" }, { 860, "Uzbekistan" },
        { 862, "Venezuela, Bolivarian Republic of" }, { 876, "Wallis and Futuna" }, { 882, "Samoa" }, { 887, "Yemen" },
        { 894, "Zambia" }, { 999, "Unknown" }, };
...
static void build_attrmap_line(char *line) {
    ...
    if (t[0] == '?') {
        attr_mapping_way2poi = g_realloc(attr_mapping_way2poi,
                    sizeof(*attr_mapping_way2poi) * (attr_mapping_way2poi_count + 1));
...
void osm_add_tag(char *k, char *v) {
    ...
    if (!g_strcmp0(k, "access")) {
        if (g_strcmp0(v, "destination"))
            ...
            AF_DANGEROUS_GOODS | AF_EMERGENCY_VEHICLES | AF_TRANSPORT_TRUCK | AF_DELIVERY_TRUCK | AF_PUBLIC_BUS
                        | AF_TAXI | AF_HIGH_OCCUPANCY_CAR | AF_CAR | AF_MOTORCYCLE | AF_MOPED | AF_HORSE | AF_BIKE
                        | AF_PEDESTRIAN;
        else
    ...
    if (!g_strcmp0(k, "vehicle")) {
        ...
        AF_DANGEROUS_GOODS | AF_EMERGENCY_VEHICLES | AF_TRANSPORT_TRUCK | AF_DELIVERY_TRUCK | AF_PUBLIC_BUS | AF_TAXI
                    | AF_HIGH_OCCUPANCY_CAR | AF_CAR | AF_MOTORCYCLE | AF_MOPED | AF_BIKE;
        level = 5;
    }
    if (!g_strcmp0(k, "motor_vehicle")) {
        flags[access_value(v)] |=
        AF_DANGEROUS_GOODS | AF_EMERGENCY_VEHICLES | AF_TRANSPORT_TRUCK | AF_DELIVERY_TRUCK | AF_PUBLIC_BUS | AF_TAXI
                    | AF_HIGH_OCCUPANCY_CAR | AF_CAR | AF_MOTORCYCLE | AF_MOPED;
        level = 5;
    }
...
void osm_end_node(struct maptool_osm *osm) {
    ...
    if (!osm->nodes || !node_is_tagged || !nodeid)
        return;
    count = attr_longest_match(attr_mapping_node, attr_mapping_node_count, types,
                sizeof(types) / sizeof(enum item_type));
    if (!count) {
...
static void process_house_number_interpolation_member(void *func_priv, void *relation_priv, struct item_bin *member,
    ...
    if (!fp->out) {
        ...
        if (attr_for_interpolation && rel->street_name) {
            ...
            char *house_number_from_to = g_strconcat(rel->house_number_first_node, "-", rel->house_number_last_node,
                        NULL);
...
static void process_multipolygons_finish(GList *tr, FILE *out) {
    ...
    while (l) {
        ...
        outer_loop_count = process_multipolygons_find_loops(multipolygon->relid, multipolygon->outer_count,
                    multipolygon->outer, &outer_scount, &outer_sequences, &outer_direction);

        /* combine inner to full loops */
        inner_loop_count = process_multipolygons_find_loops(multipolygon->relid, multipolygon->inner_count,
                    multipolygon->inner, &inner_scount, &inner_sequences, &inner_direction);
        ...
        for (b = 0; b < outer_loop_count; b++) {
            ...
            for (a = 0; a < inner_loop_count; a++) {
                ...
                used += process_multipolygons_loop_dump(multipolygon->inner, inner_scount[a], inner_sequences[a],
                            inner_direction, (struct coord*) &(buffer[used])) * sizeof(struct coord);
...
static void process_turn_restrictions_member(void *func_priv, void *relation_priv, struct item_bin *member,
    ...
    if (member->type < type_line)
        ...
        count = 2;
    turn_restriction->c[type] = g_renew(struct coord, turn_restriction->c[type],
                turn_restriction->c_count[type] + count);
...
static void process_turn_restrictions_setup_one(struct item_bin *ib, struct relations *relations,
    ...
    if (ib != NULL) {
        ...
        relations_add_relation_member_entry(relations, relations_func, turn_restriction, (gpointer) 1, viam.type,
                    viam.id);
        relations_add_relation_member_entry(relations, relations_func, turn_restriction, (gpointer) 2, tom.type,
                    tom.id);
    ...
    for (i = 0; i < sizeof(country_table) / sizeof(struct country_table); i++) {
        ...
        if (co->size) {
            ...
            while (1) {
                ...
                if (out
                            && (!r || (partsize && ((partsize + ibsize) > max_index_size))
                                        || g_strcmp0(tileprev, tilecur))) {
                    partsize = ftello(out);
                    fclose(out);
                    out = NULL;
                    index_country_add(zip_info, co->countryid, first_key, last_key,
                                strlen(tileco) > strlen(tileprev) ? tileco : tileprev, outname, partsize, countryindex);
                    g_free(outname);
                    outname = NULL;
