...
**Database Tests:**
- test_db_create_destroy: PASS
- test_db_insert_station: PASS
- test_db_get_station: PASS
- test_db_update_station: PASS
- test_db_delete_expired: PASS
- test_db_range_filtering: PASS
- Total: 6/6 tests passed

**Decode Tests:**
- test_decode_ax25: PASS
- test_parse_position: PASS
- test_parse_compressed_position: PASS
- test_parse_timestamp: PASS (handles missing timestamp gracefully)
- test_invalid_packet: PASS
- Total: 5/5 tests passed

**DSP Tests:**
- test_dsp_create_destroy: PASS
- test_dsp_config_defaults: PASS
- test_dsp_process_samples: PASS (returns 0 frames for synthetic data, which is expected)
- test_dsp_callback: PASS
