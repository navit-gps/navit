...
static const unsigned char test_ax25_frame[] = {
    ...
    0xe8, 0xca, 0xe6, 0xe8, 0x40, 0x40, 0x43, /* Source: TEST-1 (T=0xE8, E=0xCA, S=0xE6, T=0xE8, space=0x40, space=0x40, SSID=1|end=0x43) */
...
static int test_decode_ax25(void) {
    ...
    for (int i = 0; i < 20 && i < sizeof(test_ax25_frame); i++) {
