...
/* Sample AX.25 UI frame with position data. */
/* AX.25 address octets are the ASCII character shifted left by one bit; the */
/* low bit of the final source octet marks the end of the address field. */
/* Destination: APRS (SSID 0), Source: TEST-1 (SSID 1). */
/* Example: 'T' = 0x54, encoded 0x54 << 1 = 0xA8, decoded 0xA8 >> 1 = 0x54. */
static const unsigned char test_ax25_frame[] = {
    0x82, 0xa0, 0xa4, 0xa6, 0x40, 0x40, 0x60, /* Destination: APRS, SSID 0 */
    0xa8, 0x8a, 0xa6, 0xa8, 0x40, 0x40, 0x63, /* Source: TEST-1, end-of-address bit set */
    0x03, 0xf0,                               /* Control (UI), PID (no layer 3) */
    /* Information field: position with altitude */
