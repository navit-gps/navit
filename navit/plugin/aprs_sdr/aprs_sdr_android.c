...
struct aprs_sdr_android *aprs_sdr_android_new(JNIEnv *env, jobject context) {
    ...
    get_system_service_method =
        get_method_id(env, context_class, "getSystemService", "(Ljava/lang/String;)Ljava/lang/Object;");

    usb_service_name = (*env)->NewStringUTF(env, "usb");
    android_usb->usb_manager = (*env)->CallObjectMethod(env, context, get_system_service_method, usb_service_name);
    ...
    if (android_usb->usb_manager_class) {
        ...
        android_usb->get_device_list_method =
            get_method_id(env, android_usb->usb_manager_class, "getDeviceList", "()Ljava/util/HashMap;");
        android_usb->has_permission_method =
            get_method_id(env, android_usb->usb_manager_class, "hasPermission", "(Landroid/hardware/usb/UsbDevice;)Z");
        android_usb->open_device_method =
            get_method_id(env, android_usb->usb_manager_class, "openDevice",
    ...
    if (android_usb->usb_device_connection_class) {
        android_usb->usb_device_connection_class =
            (jclass)(*env)->NewGlobalRef(env, android_usb->usb_device_connection_class);
        android_usb->bulk_transfer_method = get_method_id(env, android_usb->usb_device_connection_class, "bulkTransfer",
                                                          "(Landroid/hardware/usb/UsbEndpoint;[BI)I");
        android_usb->control_transfer_method =
            get_method_id(env, android_usb->usb_device_connection_class, "controlTransfer", "(IIII[BII)I");
    }
...
int aprs_sdr_android_request_permission(struct aprs_sdr_android *android_usb, int vendor_id, int product_id) {
    ...
    jboolean has_permission = (*android_usb->env)
                                  ->CallBooleanMethod(android_usb->env, android_usb->usb_manager,
                                                      android_usb->has_permission_method, android_usb->usb_device);

    return has_permission ? 1 : 0;
}

/* Find USB device by vendor/product id. Sets android_usb->usb_device on success. */
static int aprs_sdr_android_find_device(struct aprs_sdr_android *android_usb, int vendor_id, int product_id) {
    jobject device_list;
    jobject entry_set;
    ...
    device_list =
        (*android_usb->env)
            ->CallObjectMethod(android_usb->env, android_usb->usb_manager, android_usb->get_device_list_method);
    if (!device_list) {
        dbg(lvl_warning, "No USB devices found");
        return 0;
    }
    hash_map_class = (*android_usb->env)->GetObjectClass(android_usb->env, device_list);
    entry_set_method = get_method_id(android_usb->env, hash_map_class, "entrySet", "()Ljava/util/Set;");
    entry_set = (*android_usb->env)->CallObjectMethod(android_usb->env, device_list, entry_set_method);
    iterator_class = find_class(android_usb->env, "java/util/Iterator");
    device_iterator =
        (*android_usb->env)
            ->CallObjectMethod(android_usb->env, entry_set,
                               get_method_id(android_usb->env, iterator_class, "iterator", "()Ljava/util/Iterator;"));
    has_next_method = get_method_id(android_usb->env, iterator_class, "hasNext", "()Z");
    next_method = get_method_id(android_usb->env, iterator_class, "next", "()Ljava/lang/Object;");
    get_vendor_id_method = get_method_id(android_usb->env, android_usb->usb_device_class, "getVendorId", "()I");
    get_product_id_method = get_method_id(android_usb->env, android_usb->usb_device_class, "getProductId", "()I");
    ...
    while ((*android_usb->env)->CallBooleanMethod(android_usb->env, device_iterator, has_next_method)) {
        ...
        get_key_method = get_method_id(android_usb->env, map_entry_class, "getKey", "()Ljava/lang/Object;");
        ...
        if (dev_vendor_id == vendor_id && (dev_product_id == product_id || product_id == 0)) {
...
/* Open device and get file descriptor. Returns fd or -1. */
static int aprs_sdr_android_do_open(struct aprs_sdr_android *android_usb) {
    jobject fd_obj;
    jclass file_descriptor_class;
    jmethodID get_fd_method;

    android_usb->usb_connection = (*android_usb->env)
                                      ->CallObjectMethod(android_usb->env, android_usb->usb_manager,
                                                         android_usb->open_device_method, android_usb->usb_device);
    if (!android_usb->usb_connection) {
    ...
    file_descriptor_class = find_class(android_usb->env, "java/io/FileDescriptor");
    get_fd_method = get_method_id(android_usb->env, file_descriptor_class, "getInt$", "()I");
    fd_obj = (*android_usb->env)
                 ->CallObjectMethod(android_usb->env, android_usb->usb_connection,
                                    get_method_id(android_usb->env, android_usb->usb_device_connection_class,
...
int aprs_sdr_android_open_device(struct aprs_sdr_android *android_usb, int vendor_id, int product_id) {
    ...
    if (!aprs_sdr_android_find_device(android_usb, vendor_id, product_id)) {
    ...
    return aprs_sdr_android_do_open(android_usb);
}
...
void aprs_sdr_android_close_device(struct aprs_sdr_android *android_usb) {
    ...
    if (android_usb->usb_connection) {
        jmethodID close_method =
            get_method_id(android_usb->env, android_usb->usb_device_connection_class, "close", "()V");
        if (close_method) {
            (*android_usb->env)->CallVoidMethod(android_usb->env, android_usb->usb_connection, close_method);
        }
        (*android_usb->env)->DeleteGlobalRef(android_usb->env, android_usb->usb_connection);
