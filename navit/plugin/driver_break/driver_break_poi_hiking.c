...
GList *poi_search_water_points(struct coord_geo *driver_break_stop, double radius_km) {
    ...
    GList *pois = driver_break_poi_discover(driver_break_stop, (int)radius_km, water_categories,
...
GList *poi_search_cabins(struct coord_geo *driver_break_stop, double radius_km) {
    ...
    GList *pois = driver_break_poi_discover(driver_break_stop, (int)radius_km, cabin_categories,
