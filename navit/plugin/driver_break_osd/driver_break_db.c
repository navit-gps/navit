...
static int driver_break_db_load_config_value(const char *key, int value, struct driver_break_config *config,
    ...
    static const struct config_key_map maps[] = {
        ...
        {"motorcycle_mandatory_break_after_minutes",
         offsetof(struct driver_break_config, motorcycle_mandatory_break_after_minutes), 60, MAX_MOTORCYCLE_MINUTES, 0},
        {"motorcycle_break_duration_min", offsetof(struct driver_break_config, motorcycle_break_duration_min), 5,
         MAX_BREAK_DURATION_MIN, 0},
...
int driver_break_db_save_config(struct driver_break_db *db, struct driver_break_config *config) {
    ...
    const char *keys[] = {
        ...
        "fuel_search_buffer_km", "fuel_high_load_threshold", "motorcycle_soft_limit_minutes",
        "motorcycle_mandatory_break_after_minutes", "motorcycle_break_duration_min", "motorcycle_terrain_subtype"};
