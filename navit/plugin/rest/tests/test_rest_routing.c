 ...
 *
 * Unit tests for Rest plugin routing with different vehicle profiles
 */
...
static int test_route_pilgrimage_priority(void) {
    ...
    /* Test NULL handling */
    int result = rest_route_is_pilgrimage_hiking(NULL);
...
int main(void) {
    ...
    printf("Running Rest plugin routing tests...\n");
