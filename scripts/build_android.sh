...
cmake ../ -Dvehicle/gpsd_dbus:BOOL=FALSE -Dsvg2png_scaling:STRING=0,-1,24,32,48,64,96,128,192,256 -Dsvg2png_scaling_nav:STRING=0,-1,24,32,48,64,96,128,192,256 -Dsvg2png_scaling_flag:STRING=0,-1,24,32,64,96 -DXSL_PROCESSING=y -DXSLTS=android -DANDROID=y -DDISABLE_CXX=y || exit 1
