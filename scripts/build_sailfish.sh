...
sb2 -t SailfishOS-${VERSION_ID}-armv7hl -m sdk-build rpmbuild --define "_topdir /home/nemo/rpmbuild" --define "navit_source $(pwd)/.." -bb ../project/contrib/sailfish/navit-sailfish.spec
#intel devices
...
sb2 -t SailfishOS-${VERSION_ID}-i486 -m sdk-build rpmbuild --define "_topdir /home/nemo/rpmbuild" --define "navit_source $(pwd)/.." -bb ../project/contrib/sailfish/navit-sailfish.spec
